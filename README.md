...
Encode whole numbers to an array of [protobuf-style Varint bytes](https://developers.google.com/protocol-buffers/docs/encoding#Varints) and decode them.
...
- Encode whole numbers to Varint byte arrays
- Decode Varint byte arrays to whole numbers
- Provides `encodingLength` to get the number of bytes a value will be encoded as
